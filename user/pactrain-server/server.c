...
#define FOOD_COUNT 28
#define GHOST2_COUNT 4

char* FOODLIST[] = { "C13", "E7", "D7", "C11", "B5", "D3", "D5", "A4", "E15", "E3", "E1", "D1", "B15", "C1", "B13", "E9", "B3", "D15", "C9", "B1", "D13", "C5", "C15", "D11", "E11", "C7", "C3", "D10", 0};
char* GHOST2LIST[] = { "D9", "B16", "A3", "D7", 0 };
